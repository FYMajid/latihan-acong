            ...
            <form
              ...
              <div className='sm:flex gap-6 w-full'>
                <div className='mx-0 my-2.5 flex-1'>
                  ...
                  <input
                    ...
                    placeholder='John'
                    className='w-full text-base px-4 rounded-2xl py-2.5 border-solid border border-black transition-all duration-500 focus:border-primary focus:outline-0'
                  />
                </div>
                <div className='mx-0 my-2.5 flex-1'>
                  <label
              ...
              <div className='w-full mx-0 my-2.5 flex-1'>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className='w-full mt-2 rounded-2xl px-5 py-3 border-solid border border-black transition-all duration-500 focus:outline-0'
