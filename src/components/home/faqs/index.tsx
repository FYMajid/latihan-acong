                ...
                <div className=" mx-auto px-4">
                    ...
                    <div className="space-y-4">
                        {faqData.map((item, index) => (
                            <div
                                key={index}
                                className=" border border-black rounded-lg p-4 cursor-pointer transition-all duration-300"
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    ...
                                    <Icon
                                        ...
                                        width={20}
                                        height={20}
                                        className={`text-black transform transition-transform duration-300 ${openIndex === index ? 'rotate-45' : ''}`}
                                    />
                                </div>
